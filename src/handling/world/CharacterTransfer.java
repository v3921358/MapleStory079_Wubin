...
public class CharacterTransfer implements Externalizable {
    ...
    public int totalOnlineTime;//总在线时间
    ...
    public boolean 精靈商人購買開關, 玩家私聊開關, 玩家密語開關, 好友聊天開關, 隊伍聊天開關, 公會聊天開關, 聯盟聊天開關, GM吸怪訊息開關, Vip_Medal, auto吸怪, DebugMessage, canTalk, smega, gashponmega;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.GM吸怪訊息開關 = chr.get_control_吸怪訊息();
        this.Vip_Medal = chr.getVipMedal();
        this.玩家私聊開關 = chr.get_control_玩家私聊();
        this.玩家密語開關 = chr.get_control_玩家密語();
        this.好友聊天開關 = chr.get_control_好友聊天();
        this.隊伍聊天開關 = chr.get_control_隊伍聊天();
        this.公會聊天開關 = chr.get_control_公會聊天();
        this.聯盟聊天開關 = chr.get_control_聯盟聊天();
        this.精靈商人購買開關 = chr.get_control_精靈商人();
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.GM吸怪訊息開關 = in.readBoolean();
        this.Vip_Medal = in.readBoolean();
        this.玩家私聊開關 = in.readBoolean();
        this.玩家密語開關 = in.readBoolean();
        this.好友聊天開關 = in.readBoolean();
        this.精靈商人購買開關 = in.readBoolean();
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeBoolean(this.GM吸怪訊息開關);
        out.writeBoolean(this.Vip_Medal);
        out.writeBoolean(this.精靈商人購買開關);
        out.writeBoolean(this.玩家私聊開關);
        out.writeBoolean(this.玩家密語開關);
        out.writeBoolean(this.好友聊天開關);
        out.writeBoolean(this.隊伍聊天開關);
        out.writeBoolean(this.公會聊天開關);
        out.writeBoolean(this.聯盟聊天開關);
