...
public class AdminCommand {
    ...
    public static class MesoEveryone extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!mesoeveryone <数量> - 给所有玩家枫币").toString();
        }
    }
    ...
    public static class WarpAllHere extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!WarpAllHere 把所有玩家传送到这裡").toString();
        }
    }
...
//                    c.getPlayer().getMap().broadcastMessage(MaplePacketCreator.spawnNPC(npc, true));
    ...
    public static class maxmeso extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!maxmeso - 枫币满").toString();
        }
    }
    ...
    public static class 怪物区 extends CommandExecute {
