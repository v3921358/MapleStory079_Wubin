...
public class PracticerCommand {
    ...
    public static class 玩家密语 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            MapleCharacter p = c.getPlayer();
            boolean x = p.get_control_玩家密語();
            if (x) {
                p.control_玩家密語(false);
            } else {
                p.control_玩家密語(true);
            }
            x = p.get_control_玩家密語();
    ...
    public static class 队伍聊天 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            MapleCharacter p = c.getPlayer();
            boolean x = p.get_control_隊伍聊天();
            if (x) {
                p.control_隊伍聊天(false);
            } else {
                p.control_隊伍聊天(true);
            }
            x = p.get_control_隊伍聊天();
    ...
    public static class 公会聊天 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            MapleCharacter p = c.getPlayer();
            boolean x = p.get_control_公會聊天();
            if (x) {
                p.control_公會聊天(false);
            } else {
                p.control_公會聊天(true);
            }
            x = p.get_control_公會聊天();
    ...
    public static class 联盟聊天 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            MapleCharacter p = c.getPlayer();
            boolean x = p.get_control_聯盟聊天();
            if (x) {
                p.control_聯盟聊天(false);
            } else {
                p.control_聯盟聊天(true);
            }
            x = p.get_control_聯盟聊天();
    ...
    public static class 吸怪讯息 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            MapleCharacter p = c.getPlayer();
            boolean x = p.get_control_吸怪訊息();
            if (x) {
                p.control_吸怪訊息(false);
            } else {
                p.control_吸怪訊息(true);
            }
            x = p.get_control_吸怪訊息();
